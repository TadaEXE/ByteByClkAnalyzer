...
void ByteByClkAnalyzer::WorkerThread()
{
	...
	U32 samples_to_first_center_of_first_data_bit = 1; // U32( 1.5 * double( mSampleRateHz ) / double( mSettings.mBitRate ) );
...
U32 ByteByClkAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate, SimulationChannelDescriptor** simulation_channels )
{
